...
JOB_GROUP character varying(60)  NOT NULL,
CRON character varying(30) ,
STATUS int2 NOT NULL
);
alter table JOB_DEF add primary key(JOB_NAME,JOB_GROUP);
COMMENT ON COLUMN "public"."job_def"."status" IS '状态(0：正常，1：禁用)';
